...
EXAMPLE_WEIGHT = add_metric_prefix('example_weight')
EXAMPLE_COUNT = add_metric_prefix('example_count')
CALIBRATION_PLOT_MATRICES = add_metric_prefix('calibration_plot/matrices')
CALIBRATION_PLOT_BOUNDARIES = add_metric_prefix('calibration_plot/boundaries')
CONFUSION_MATRIX_AT_THRESHOLDS_MATRICES = add_metric_prefix(
    'confusion_matrix_at_thresholds/matrices')
CONFUSION_MATRIX_AT_THRESHOLDS_THRESHOLDS = add_metric_prefix(
    'confusion_matrix_at_thresholds/thresholds')
CONFUSION_MATRIX_AT_THRESHOLDS = add_metric_prefix(
    'confusion_matrix_at_thresholds')  # Output-only
FAIRNESS_CONFUSION_MATRIX_MATRICES = add_metric_prefix(
    'fairness/confusion_matrix_at_thresholds/matrices')
FAIRNESS_CONFUSION_MATRIX_THESHOLDS = add_metric_prefix(
    'fairness/confusion_matrix_at_thresholds/thresholds')
FAIRNESS_CONFUSION_MATRIX = add_metric_prefix(
    'fairness/confusion_matrix_at_thresholds')  # Output-only
AUC_PLOTS_MATRICES = add_metric_prefix('auc_plots/matrices')
AUC_PLOTS_THRESHOLDS = add_metric_prefix('auc_plots/thresholds')
AUC = add_metric_prefix('auc')
AUPRC = add_metric_prefix('auprc')
PRECISION_RECALL_AT_K = add_metric_prefix('precision_recall_at_k')
